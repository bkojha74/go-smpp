...
import (
	...
	"github.com/bkojha74/go-smpp/smpp/pdu/pdufield"
	"github.com/bkojha74/go-smpp/smpp/pdu/pdutlv"
)
...
func Decode(r io.Reader) (Body, error) {
	...
	case AlertNotificationID:
		// TODO(bkojha74): Implement AlertNotification.
	...
	case CancelSMID:
		// TODO(bkojha74): Implement CancelSM.
	case CancelSMRespID:
		// TODO(bkojha74): Implement CancelSMResp.
	case DataSMID:
		// TODO(bkojha74): Implement DataSM.
	case DataSMRespID:
		// TODO(bkojha74): Implement DataSMResp.
	case DeliverSMID:
	...
	case OutbindID:
		// TODO(bkojha74): Implement Outbind.
	case QuerySMID:
		return decodeFields(newQuerySM(hdr), b)
	case QuerySMRespID:
		return decodeFields(newQuerySMResp(hdr), b)
	case ReplaceSMID:
		// TODO(bkojha74): Implement ReplaceSM.
	case ReplaceSMRespID:
		// TODO(bkojha74): Implement ReplaceSMResp.
	case SubmitMultiID:
